...
/*
Precondition: None
Postcondition: Allocate space for string object that represents empty string.
 The string will have capacity 7 and size 0 by default. A copy of the opaque
 object will be returned on success and NULL on failure
*/
MY_STRING my_string_init_default(void);

/*
Precondition: c_string is a valid null terminated c-string.
Postcondition: Allocate space for a string object with the same value as
 given c-string. The capacity of the strignobject will be set to one greater
 than is required to hold the string. As an example the string"the" would be
 capacity 4 instead of 3. A copy of the address of the opaque object will be
...
/*
Precondition: phMy_string holds address of valid handle to a MY_STRING
 object.
Postcondition: The memort used for MY_String object has been reclaimed by
 system and the handle refered to by pointer phMy_string has been set to
 NULL
*/
